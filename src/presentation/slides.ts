...
export const slides = [
  ...
  },
  {
    ...
    theme: 'conflict',
    content: `<div class="wide-heading"><p class="eyebrow">DIGITISATION HAS MADE THE EVERYDAY EASIER</p><h1>Sam can transact.<br><em>Progress is a different job.</em></h1></div><p class="transaction-proof">Pay someone. Check a balance. Apply for an account or product.</p><div class="gap-diagram"><div class="tool-cloud"><span>Accounts</span><span>Budgets</span><span>Investments</span><span>Payments</span><span>Mortgages</span><span>Pensions</span><span>Alerts</span><span>Savings Pots</span><span>Life Planner</span></div><div class="missing-link"><span class="broken-line"></span><b>Choosing a path.<br>Keeping it going.</b><span class="broken-line"></span></div><div class="outcome-destination">${icon('trending_up')}<span>The life<br>Sam wants</span></div></div><p class="closing-line">If features alone were the solution, we would have solved this.<br>The next opportunity is to turn access into lasting progress.</p>`,
  },
  {
    stage: 'Conflict',
    title: 'Complete a task. Support a lasting change.',
    theme: 'behaviour-bridge',
    content: `<div class="wide-heading"><p class="eyebrow">TWO DIFFERENT DESIGN JOBS</p><h1>Complete a task.<br><em>Support a lasting change.</em></h1></div><div class="journey-comparison"><article class="transaction-journey"><span class="mini-label">TRANSACTIONAL JOURNEY</span><h2>“I need to pay this bill.”</h2><p class="journey-motivation">The need is immediate: a reason to act now.</p><div class="transaction-steps"><span>Need now</span>${icon('arrow_forward')}<span>Act</span>${icon('arrow_forward')}<span>Relief</span></div><p class="journey-time">The bill is paid. Solving the problem is the reward.</p><div class="journey-design"><b>Design a feature or product journey.</b><p>Make it easy to understand, act and finish.</p></div></article><article class="transformation-journey"><span class="mini-label">TRANSFORMATIONAL JOURNEY</span><h2>“I want a financial buffer.”</h2><p class="journey-motivation">The goal matters, but can feel far away.</p><div class="behaviour-cycle"><span>Prompt</span>${icon('arrow_forward')}<span>Act</span>${icon('arrow_forward')}<span>Reward</span>${icon('repeat')}</div><p class="journey-time">One step won’t finish the job. Give effort a payoff now.</p><div class="journey-design"><b>Design a system of support.</b><p>Offer timely prompts. Make small actions easy. Recognise progress while the bigger reward is still ahead.</p></div></article></div><p class="journey-conclusion">Features make the steps work. A trusted relationship helps us support the change between them.</p>`,
  },
  {
  ...
  },
  {
    ...
    theme: 'product now',
    content: `<div class="product-copy"><p class="eyebrow">NOW · COMPETENCE · MY EVERYDAY LIFE</p><h1>Build the confidence<br>to <em>act.</em></h1><p class="lead">“I can see where I stand.<br>I know what I can do next.”</p><div class="action-sequence"><div><span>01</span><p><b>Make sense of today</b>Personalised numbers and Stories turn data into meaningful moments. Choose, resize and arrange your numbers.</p></div><div><span>02</span><p><b>Make a useful move</b>As Sam scrolls, the AI conversation changes with the section he is viewing. Conversation and visuals work together.</p></div><div><span>03</span><p><b>Make it easier to repeat</b>His interests shape the Stories he sees. Pots and Money Rules turn a useful insight into a routine.</p></div></div><p class="tab-handoff">Confidence today creates room to choose a future.</p><a class="text-link" data-demo href="/?p=sam&tab=now&theme=vanilla">Explore Sam’s Now ${icon('arrow_forward')}</a></div>${phone('now', 'Sam’s Now screen with the AI Companion, money overview and everyday commitments.')}`,
  },
  {
    stage: 'Resolution',
    title: 'Future: choose a future worth keeping going for',
    theme: 'product future',
    content: `<div class="product-copy"><p class="eyebrow">FUTURE · AUTONOMY · MY POSSIBLE FUTURE</p><h1>Choose a future.<br><em>Make it your own.</em></h1><p class="lead">“I can try a different path.<br>The choice is mine.”</p><div class="future-example"><span class="mini-label">SAM TRIES A PAYDAY SAVINGS RULE</span><div class="example-amount">+£50<span>/month</span></div><p>Emergency fund: <strong>11 months closer.</strong></p></div><p class="supporting">AI suggests possibilities from Sam’s goals and life stage.<br>Time Travel changes both the visual future and the AI conversation. What If reveals trade-offs; a Money Rule makes his choice repeatable.</p><p class="tab-handoff">A personally meaningful goal gives the routine a reason.</p><a class="text-link" data-demo href="/?p=sam&tab=future&theme=vanilla">Explore Sam’s Future ${icon('arrow_forward')}</a></div>${phone('future', 'Sam’s Future bubble canvas and Time Travel bar, showing goals and suggested possibilities.')}`,
  },
  {
    stage: 'Resolution',
    title: 'You: feel connected, recognised and valued',
    theme: 'product you',
    content: `<div class="product-copy"><p class="eyebrow">YOU · RELATEDNESS · MY RELATIONSHIPS</p><h1>Feel connected.<br>Recognised.<br><em>Valued.</em></h1><div class="action-sequence"><div><span>01</span><p><b>A relationship that listens</b>Check-ins add feelings and intentions to our memory of Sam. The portrait shows our interpretation; Behind the portrait shows the evidence he can question.</p></div><div><span>02</span><p><b>A relationship that includes my world</b>My household, shared goals and human support.</p></div><div><span>03</span><p><b>A relationship worth celebrating</b>Journey milestones, Points and Badges recognise progress. Status brings benefits to explore.</p></div></div><p class="tab-handoff">Understanding, recognition and benefits give him reasons to stay connected.</p><a class="text-link" data-demo href="/?p=sam&tab=you&theme=vanilla">Explore Sam’s You ${icon('arrow_forward')}</a></div>${phone('you', 'Sam’s You screen with household recognition, Money Check-in and his Planner portrait.')}`,
  },
  {
    stage: 'Resolution',
    title: 'Customer knowledge and memory, shared across the bank',
    theme: 'system',
    content: `<div class="wide-heading"><p class="eyebrow">HOW WE DELIVER ALL THREE</p><h1>The whole bank.<br><em>Made relevant to one person.</em></h1></div><div class="system-flow"><div class="bank-inputs"><span class="flow-label">What the bank can offer</span><div class="input-bubbles"><span>Capabilities</span><span>Tools</span><span>Messages</span><span>Features</span><span>Products</span><span>Data</span></div></div><span class="flow-arrow" aria-hidden="true">${icon('arrow_forward')}</span><div class="behaviour-layer"><span class="flow-label">Building knowledge over time</span>${icon('auto_awesome')}<h2>AI behavioural<br> layer</h2><p>Remember what Sam shares.<br>Learn from patterns and choices.<br>Support his next step.</p><div class="layer-faces"><span>Behind the scenes</span><span>In the experience</span></div></div><span class="flow-arrow" aria-hidden="true">${icon('arrow_forward')}</span><div class="system-output"><span class="flow-label">What the customer experiences</span><div class="companion-example"><span>${icon('auto_awesome')}</span><p>Conversation + visual insight.<br>Relevant to what Sam sees now.</p></div><div class="system-tabs"><b>Now</b><b>Future</b><b>You</b></div><p class="customer-choice">Customer choice.<br>Human support when it matters.</p></div></div><div class="system-loop"><span></span><p>One growing memory across Now, Future and You. Visible to Sam, open to correction.</p><span></span></div>`,
  },
  {
    stage: 'Resolution',
    title: 'A relationship earned, again and again',
    theme: 'flywheel',
    content: `<div class="flywheel-intro"><p class="eyebrow">HOW THE SYSTEM STRENGTHENS OVER TIME</p><h1>A relationship<br>is <em>earned.</em><br>Again and again.</h1><p class="lead">Each useful moment can make<br>the next one more relevant.</p><p class="supporting">Now helps Sam act. Future gives it purpose.<br>You builds connection and recognition.</p></div><div class="relationship-wheel"><div class="wheel-center"><span>AI + behavioural tools</span><b>Learn. <br>Support. <br>Earn trust.</b></div><ol class="wheel-steps"><li><span class="wheel-number">01</span><h2>Meaningful <br>interactions</h2><p>A check-in. A useful next step.</p>${icon('arrow_forward')}</li><li><span class="wheel-number">02</span><h2>Knowledge <br>and memory</h2><p>Patterns, intentions and choices over time.</p>${icon('arrow_forward')}</li><li><span class="wheel-number">03</span><h2>Stronger relationship <br>and trust</h2><p>Dependable help. Visible understanding.</p>${icon('arrow_forward')}</li><li><span class="wheel-number">04</span><h2>More personal <br>support</h2><p>Recommendations that build on his history.</p>${icon('arrow_forward')}</li><li><span class="wheel-number">05</span><h2>Sustained behaviours.<br>Better outcomes.</h2><p>Progress gives a reason to return.</p>${icon('arrow_forward')}</li></ol><p class="wheel-return">Progress brings the next meaningful interaction.</p></div><p class="flywheel-principle">The reinforcing loop we want to test: more useful support, sustained action, greater progress.</p>`,
  },
  {
    stage: 'Resolution',
    title: 'Why the bank should earn that deeper role',
    theme: 'shared-value',
    content: `<div class="wide-heading"><p class="eyebrow">WHY THIS MATTERS TO HSBC</p><h1>When customers move forward,<br><em>the relationship can grow too.</em></h1></div><div class="shared-value-grid"><article><span class="mini-label">VALUE FOR THE CUSTOMER</span><h2>More capable.<br>More choice.<br>More progress.</h2><p>Clearer decisions and sustainable routines<br>in service of their own goals.</p></article><div class="shared-value-link">${icon('swap_horiz')}<span>Value earned<br>over time</span></div><article><span class="mini-label">VALUE FOR THE BANK</span><h2>More trust.<br>More continuity.<br>More relevance.</h2><p>A shared history worth building on.<br>No need to explain life from scratch each time.<br>A reason to return as new needs arise.</p></article></div><p class="shared-value-test">Our hypothesis: helping customers sustain progress can build loyalty and appropriate growth.</p>`,
  },
  {
    stage: 'Soundbite',

...
export const slides = [
  ...
  {
    stage: 'Conflict',
    title: 'Long-term progress is built between the transactions',
    theme: 'behaviour-bridge',
    content: `<div class="wide-heading"><p class="eyebrow">WHY A BETTER TOOL IS ONLY PART OF THE ANSWER</p><h1>Long-term progress is built<br><em>between the transactions.</em></h1></div><div class="sustained-path"><article><span>CHOOSE</span><h2>Make a plan<br>that fits.</h2><p>Balance Ella’s future with<br>what the family needs today.</p></article><article><span>REPEAT</span><h2>Keep making<br>small moves.</h2><p>Set money aside on payday.<br>Make the routine easier.</p></article><article><span>ADAPT</span><h2>Keep it relevant<br>as life changes.</h2><p>Revisit the plan when<br>priorities or income change.</p></article></div><div class="trust-bridge"><b>Useful support can help him keep going.</b><p>Trust gives us permission to stay involved.<br>Consistent help gives him a reason to trust us.</p></div>`,
  },
  {
    stage: 'Strategic shift',
    title: 'From product loyalty to relationship loyalty',
    theme: 'loyalty',
    content: `<div class="wide-heading"><p class="eyebrow">THE STRATEGIC SHIFT</p><h1>From product loyalty<br>to <em>relationship loyalty.</em></h1></div><div class="continuity-story"><article><span class="mini-label">PERSONAL CONTACT</span>${icon('group')}<h2>A conversation.<br>A familiar face.</h2><p>What we value in personal banking:<br>context, continuity and judgement.</p></article><article><span class="mini-label">DIGITAL CONVENIENCE</span>${icon('credit_card')}<h2>More access.<br>Less effort.</h2><p>Everyday banking in Sam’s hands.<br>This convenience stays essential.</p></article><article><span class="mini-label">THE NEXT OPPORTUNITY</span>${icon('auto_awesome')}<h2>Personal support.<br>At digital scale.</h2><p>Offer relevant help over time.<br>Earn a role beyond the transaction.</p></article></div><p class="strategy-close">Sam wants to get on with his life.<br><strong>We have to make a deeper relationship worth his while.</strong></p>`,
  },
  {
    stage: 'Big idea',
  ...
  },
  {
    ...
    theme: 'principles',
    content: `<div class="wide-heading"><p class="eyebrow">WHAT THAT RELATIONSHIP SHOULD HELP PEOPLE FEEL</p><h1>Three sides of a person.<br><em>Three foundations for progress.</em></h1></div><div class="needs"><article class="need competence"><span class="person-side">My everyday life</span><div class="need-symbol">${icon('check')}</div><h2>Competence</h2><p>“I can manage this.”</p><span class="need-tab">Now</span></article><article class="need autonomy"><span class="person-side">My possible future</span><div class="need-symbol">${icon('trending_up')}</div><h2>Autonomy</h2><p>“I can choose my path.”</p><span class="need-tab">Future</span></article><article class="need relatedness"><span class="person-side">My relationships</span><div class="need-symbol">${icon('group')}</div><h2>Relatedness</h2><p>“I belong. I’m valued.”</p><span class="need-tab">You</span></article></div><p class="source-line">Our design application of <a href="https://selfdeterminationtheory.org/the-theory/" target="_blank" rel="noreferrer">Self-Determination Theory</a>. Each tab leads with one need; all three work together.</p>`,
  },
  {
    stage: 'Resolution',
  ...
  },
  {
    ...
    theme: 'closing',
    content: `<p class="eyebrow">MAKING BANKING A RELATIONSHIP AGAIN</p><h1>Building better<br>customers builds<br><em>a better bank.</em></h1><p class="lead">Capable in the Now. Free to shape the Future.<br>Connected and valued in You.</p><div class="value-chain"><span>Supported choices</span>${icon('arrow_forward')}<span>Sustained behaviours</span>${icon('arrow_forward')}<span>Better outcomes</span></div><div class="closing-action"><a class="primary-link" data-demo href="/?p=sam&tab=now&theme=vanilla">Experience it with Sam ${icon('arrow_forward')}</a><p>Let’s test whether useful support earns trust<br>and helps people sustain progress.</p></div>`,
  },
];

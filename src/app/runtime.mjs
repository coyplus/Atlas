...
function render() {
  ...
  renderRegion(
    ...
    `<aside class="presenter"><div class="presenter-brand">${logo()}<b>HSBC</b><span>Atlas</span></div><p class="eyebrow">FOUR MOMENTS · ONE RELATIONSHIP</p><h1>Making banking a<br>relationship again</h1><p class="presenter-intro">Building better customers builds a better bank.</p><nav class="moment-picker">${Object.entries(
      ...
      .join(
        '',
      )}</nav><div class="presenter-bottom"><span class="eyebrow">${esc(S.direction)} EDITION</span><p>Interactive concept · illustrative data<br>Changes stay in this demonstration.</p>${button('Reset this moment', 'reset', 'text')}<a href="workbench.html">Component workbench ${icon('arrow')}</a></div></aside>

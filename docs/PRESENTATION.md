...
## Narrative Companion demonstrations

The cover and slide 8 render `companionCard` from `src/features/support/card.mjs`,
the same card mounted by the prototype’s support controller. The surface, icon
